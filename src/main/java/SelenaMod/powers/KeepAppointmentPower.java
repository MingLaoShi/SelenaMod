...
public class KeepAppointmentPower extends AbstractPower {
    ...
    public void onRemove() {
        for (int i = 0; i < this.count; i++) {
            addToBot(new DamageAction(this.target, new DamageInfo(this.owner, this.damage, DamageInfo.DamageType.HP_LOSS), AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
